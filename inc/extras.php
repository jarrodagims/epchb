...
if( function_exists('acf_add_options_page') ) {
	...
	'page_title' 	=> 'Address and Testimonials',
...
add_shortcode( 'testimonials', 'elp_testimonials' );
function elp_testimonials() {
...
echo '<div class="slider">';
 ...
 $image = get_sub_field('testimonial_image','option'); 
	$alt_text = get_sub_field('testimonial_image_alt_text','option')
 ?>
<div class="slider-wrapper" ><div class="slider-content"> <?php echo $content;?></div> <div class="slider-img"><img src="<?php echo $image['url']; ?>" alt="<?php echo $alt_text;?>"/></div></div>
