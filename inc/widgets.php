...
function gff_starter_widgets_init() {
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Home Call Out Section', 'gff-starter' ),
		'id'            => 'home-callout',
		'class'         => 'home-section-callout',
		'description'   => esc_html__( 'Widget Area for Home Section Callout Area.', 'gff-starter' ),
		'before_widget' => '<section id="%1$s" class="widget home-callout-widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title header-widget-title">',
		'after_title'   => '</h2>',
	) );
		register_sidebar( array(
		'name'          => esc_html__( 'Home Section Steps', 'gff-starter' ),
		'id'            => 'home-steps',
		'class'         => 'home-section-steps',
		'description'   => esc_html__( 'Widget Area for Home Section Steps.', 'gff-starter' ),
		'before_widget' => '<section id="%1$s" class="widget home-steps-widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title header-widget-title">',
		'after_title'   => '</h2>',
	) );
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar Widget 1', 'gff-starter' ),
		'id'            => 'right-widget-1',
		'class'         => 'slider-widget-section1',
		'description'   => esc_html__( 'Sidebar widget section 1', 'gff-starter' ),
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar Widget 2', 'gff-starter' ),
		'id'            => 'right-widget-2',
		'class'         => 'global-widget-section2',
		'description'   => esc_html__( 'Sidebar widget section 2', 'gff-starter' ),
		'before_widget' => '<section id="%1$s" class="widget global-section2-widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title global-section2-widget-title" style="margin-top:0px;">',
		'after_title'   => '</h2>',
	) );
		register_sidebar( array(
		'name'          => esc_html__( 'Sidebar Widget 3', 'gff-starter' ),
		'id'            => 'right-widget-3',
		'class'         => 'global-widget-section3',
		'description'   => esc_html__( 'Sidebar widget section 3', 'gff-starter' ),
		'before_widget' => '<section id="%1$s" class="widget global-section3-widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title global-section3-widget-title" style="margin-top:0px;">',
		'after_title'   => '</h2>',
	) );
		register_sidebar( array(
		'name'          => esc_html__( 'Sidebar Widget 4', 'gff-starter' ),
		'id'            => 'right-widget-4',
		'class'         => 'global-widget-section4',
		'description'   => esc_html__( 'Sidebar widget section 4', 'gff-starter' ),
		'before_widget' => '<section id="%1$s" class="widget global-section4-widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title global-section4-widget-title" style="margin-top:0px;">',
		'after_title'   => '</h2>',
	) );
		register_sidebar( array(
		'name'          => esc_html__( 'Sidebar Widget 5', 'gff-starter' ),
		'id'            => 'right-widget-5',
		'class'         => 'global-widget-section5',
		'description'   => esc_html__( 'Sidebar widget section 5', 'gff-starter' ),
		'before_widget' => '<section id="%1$s" class="widget global-section5-widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title global-section5-widget-title" style="margin-top:0px;">',
		'after_title'   => '</h2>',
	) );
		register_sidebar( array(
		'name'          => esc_html__( 'Banner Text Widget', 'gff-starter' ),
		'id'            => 'banner-text-widget',
		'class'         => 'global-widget-section2',
		...
		register_sidebar( array(
		'name'          => esc_html__( 'Header Phone Number and Social Icons', 'gff-starter' ),
		'id'            => 'header-call-and-social',
		'class'         => 'global-widget-section3',
		'description'   => esc_html__( 'Global widget section under main content 3.', 'gff-starter' ),
		'before_widget' => '<section id="%1$s" class="widget header-social-widget row %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title global-section3-widget-title">',
		'after_title'   => '</h2>',
	) );
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Content and Social Icons', 'gff-starter' ),
		'id'            => 'footer-content-and-social',
		'class'         => 'global-widget-section4',
